...
<body>
    ...
    <div class="container">
        ...
        <a href="<c:url value='/hospital/login' />" class="login-btn hospital">Hospital Login</a>

        <!-- Doctor Login Button -->
        <a href="<c:url value='/doctor/login' />" class="login-btn doctor">Doctor Login</a>

        <!-- Pharmacy Login Button -->
        <a href="<c:url value='/pharmacy/login' />" class="login-btn pharmacy">Pharmacy Login</a>
    </div>
